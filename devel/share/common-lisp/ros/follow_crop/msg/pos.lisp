...
(cl:defmethod cl:initialize-instance :after ((m <pos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name follow_crop-msg:<pos> is deprecated: use follow_crop-msg:pos instead.")))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader follow_crop-msg:direction-val is deprecated.  Use follow_crop-msg:direction instead.")
  (direction m))
